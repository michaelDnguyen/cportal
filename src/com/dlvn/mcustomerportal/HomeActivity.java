...
public class HomeActivity extends AppCompatActivity {
    ...
    private void loadNavHeader() {
     ...
     // loading header background image
        imageLoader.displayImage(urlNavHeaderBg, imgNavHeaderBg, new ImageLoadingListener() {

			@Override
			public void onLoadingStarted(String arg0, View arg1) {
				myLog.E("Started Load Image!");
			}

			@Override
			public void onLoadingFailed(String arg0, View arg1, FailReason arg2) {
				// TODO Auto-generated method stub
				myLog.E("Error Load Image!");
			}

			@Override
			public void onLoadingComplete(String arg0, View arg1, Bitmap arg2) {
				myLog.E("Load Image Success!");
			}

			@Override
			public void onLoadingCancelled(String arg0, View arg1) {
				myLog.E("Cancel Load Image!");
			}
		});
        

        // Loading profile image
        imageLoader.displayImage(urlProfileImg, imgProfile, new ImageLoadingListener() {
